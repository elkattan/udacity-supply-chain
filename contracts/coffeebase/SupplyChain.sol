    ...
    DistributorRole
{
    ...
    constructor() public payable {
        // owner and owner-related methods are defined in Ownable constract
        sku = 1;
        upc = 1;
    }
    ...
    function harvestItem(
        ...
        items[_upc] = Item({
            sku: sku,
            upc: _upc,
            ownerID: _originFarmerID, // The current owner is the farmer
    ...
    function buyItem(uint256 _upc)
        ...
        // Check caller role when first itroduce to the supply chain
        onlyDistributor
    {
